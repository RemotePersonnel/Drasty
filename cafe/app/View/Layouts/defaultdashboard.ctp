...
<head>
  ...
  -->
  <!--<script type="text/javascript" src="<?php echo $this->webroot; ?>vendor/plugins/datatables/extras/TableTools/media/js/TableTools.min.js"></script>-->
  <!-- Datatable TableTools Addon -->
  ...
  <!-- Store setting -->
   ...
   <?php  echo $this->Html->script('timeslider-custom'); ?>
   
  <!-- Time Slider End -->

  <!-- expand div -->
   <?php  echo $this->Html->script('expand'); ?>
  <!-- expand div End -->
...
<div id="dashboard-container">
    ...
    <header class="navbar navbar-fixed-top">
      ...
      <div class="pull-right header-btns">
        <?php echo $this->element('dashboard-topright-nav'); ?>  
      </div>
    </header>
    <!-- End: Header --> 
    <!-- Start: Main -->
